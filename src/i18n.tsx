...
const T = {
  de: {
    ...
    hero: {
      ...
      metaLocationValue: 'Flugplatz Oberpfaffenhofen',
      ...
      weather: {
        ...
        stationName: 'EDMO · Oberpfaffenhofen',
      },
    },
    experiences: {
    ...
    flights: [
      { id: 'schnupper', title: 'Schnupperflug',   price: '149 €', description: 'Der perfekte Einstieg. 30 Minuten pure Faszination inklusive Einweisung in die Technik.' },
      { id: 'alpen',     title: 'Alpenrundflug',   price: '279 €', featured: true, description: '60 Minuten atemberaubende Panoramaausblicke über die Zugspitze und das Voralpenland.' },
      { id: 'schloesser',title: 'Schlössertour',   price: '399 €', description: 'Königliche Perspektiven. 90 Minuten Flugzeit über Neuschwanstein und Hohenschwangau.' },
    ],
    about: {
      eyebrow: 'Über mich',
      ...
      imgCockpitAlt: 'Blick aus dem Gyrocopter während des Flugs',
    },
    voucher: {
      eyebrow: 'Gutscheine',
    ...
    preparation: {
      ...
      arrivalHeading: 'Flugplatz Oberpfaffenhofen',
      arrivalAddress: 'Flugplatz Oberpfaffenhofen (EDMO)\n82205 Gilching',
      arrivalItems: [
        'Mit dem Auto: A96, Ausfahrt Gilching-West, dann ca. 4 km Richtung Flugplatz.',
        'Kostenfreie Parkplätze direkt am Flugplatz vorhanden.',
        'Mit dem ÖPNV: S-Bahn S8 bis Gilching-Argelsried, dann Bus 942 bis Flugplatz (ca. 20 Min. Gesamt-Fahrtzeit ab München Hbf).',
      ],
    ...
    faq: {
      ...
      facts: [
        ...
        { k: 'Max. Gewicht',   v: 'bis 110 kg',   sub: 'Pro Passagier, aus Sicherheitsgründen' },
    ...
    footer: {
      ...
      cols: [
        ...
        { title: 'Kontakt', links: [
          { label: 'Flugplatz Oberpfaffenhofen', href: null },
  ...
  en: {
    ...
    nav: {
      ...
      links: [
        ...
        { href: '#vorbereitung', label: 'Preparation' },
    ...
    hero: {
      ...
      metaLocationValue: 'Oberpfaffenhofen Airfield',
    ...
    flights: [
      { id: 'schnupper', title: 'Introductory Flight', price: '€149', description: 'The perfect first step. 30 minutes of pure fascination including a technical briefing.' },
      { id: 'alpen',     title: 'Alpine Scenic Flight', price: '€279', featured: true, description: '60 minutes of breathtaking panoramic views over the Zugspitze and the Alpine foothills.' },
      { id: 'schloesser',title: 'Castle Tour',          price: '€399', description: 'Royal perspectives. 90 minutes of flight time over Neuschwanstein and Hohenschwangau.' },
    ],
    about: {
      eyebrow: 'About me',
      ...
      imgCockpitAlt: 'View from the gyrocopter cockpit during the flight',
    },
    voucher: {
    ...
    preparation: {
      ...
      arrivalHeading: 'Oberpfaffenhofen Airfield',
      arrivalAddress: 'Oberpfaffenhofen Airfield (EDMO)\n82205 Gilching, Germany',
      arrivalItems: [
        'By car: A96 motorway, exit Gilching-West, then approx. 4 km towards the airfield.',
        'Free parking directly at the airfield.',
        'By public transport: S-Bahn S8 to Gilching-Argelsried, then bus 942 to the airfield (approx. 20 min total from Munich central station).',
      ],
    ...
    faq: {
      ...
      facts: [
        ...
        { k: 'Max. weight',  v: 'up to 110 kg',  sub: 'Per passenger, for safety reasons' },
    ...
    faqs: [
      ...
      { q: 'Is there a weight limit?', a: 'For safety reasons there is an upper limit of 110 kg, which we sort out together without any fuss at the time of booking.' },
    ...
    footer: {
      ...
      cols: [
        ...
        { title: 'Contact', links: [
          { label: 'Oberpfaffenhofen Airfield', href: null },
          { label: '+49 (0) 89 123 456 78',     href: 'tel:+498912345678' },
          { label: 'info@meintraumflug.de',     href: 'mailto:info@meintraumflug.de' },
        ]},
      ],
